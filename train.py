...
from homura.vision.models.cifar_resnet import wrn28_2, wrn28_10, resnet20, resnet56, resnext29_32x4d, cifar_resnet18
from homura.vision.models.PyramidNet import PyramidNet
...
def train(args): 
    ...
    for epoch in range(args.epochs):
        ...
        writer.add_scalar('Loss/train', scalar_value = loss, global_step = epoch)
        writer.add_scalar('Accuracy/train', scalar_value= accuracy, global_step = epoch)
        scheduler.step()
        ...
        writer.add_scalar('Loss/Test', scalar_value = loss)
        writer.add_scalar('Accuracy/Test', scalar_value = accuracy)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", default='PyramidNet', type=str, help="Name of model architecure")
    parser.add_argument("--minimizer", default='SAM', type=str, help="ASAM or SAM.")
    parser.add_argument("--lr", default=0.1, type=float, help="Initial learning rate.")
    parser.add_argument("--momentum", default=0.9, type=float, help="Momentum.")
    parser.add_argument("--weight_decay", default=0, type=float, help="Weight decay factor.")
